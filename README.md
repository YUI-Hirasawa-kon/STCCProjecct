...
- Read: The background list is clickable.`View` View details (`/movies/<movie_id>`).
...
- Create:
  - (Linux):
  ```
  curl -X POST "https://stccprojecct.onrender.com/api/movies" -H "Content-Type: application/json" -d '{"title": "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX", "description": "Classic action film", "posterUrl": "https://scholars.hkmu.edu.hk/files-asset/19040519/5619180f6b22b3be379691a86a293cdf.jpg/
  ...
  - (Window):
  ```
  curl -X POST "https://stccprojecct.onrender.com/api/movies" -H "Content-Type: application/json" -d "{\"title\": \"XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\", \"description\": \"Classic action film\", \"posterUrl\": \"https://scholars.hkmu.edu.hk/files-asset/19040519/5619180f6b22b3be379691a86a293cdf.jpg/\", \"rating\": \"IIB\", \"releaseDate\": \"2025-11-14\", \"director\": \"Jackie Chan\", \"genres\": [\"Action\", \"Crime\"], \"duration\": 100, \"language\": \"Cantonese\", \"theaterLocation\": \"HongKong\", \"cast\": [\"Jackie Chan\", \"Brigitte Lin\"], \"showTimes\": [\"14:30\", \"19:30\"]}"
  ```
- Update:
  - (Linux):
  ```
   curl -X PUT "https://stccprojecct.onrender.com/api/movies/<movie_id>" \
  ...
  - (Window):
  ```
   curl -X PUT "https://stccprojecct.onrender.com/api/movies/<movie_id>" -H "Content-Type: application/json" -d "{"duration": 95, "isFull": true}"
  ```
- Delete:
```
